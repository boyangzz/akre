<div class="page-header">
    <h4><i class="bi bi-heart me-2"></i>PkM DTPS (3.b.3)</h4>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
            <li class="breadcrumb-item active">PkM DTPS</li>
        </ol>
    </nav>
</div>
...
<div class="row g-3">
    <div class="col-12 mb-3">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="<?= base_url('sumber_daya/pkm_save') ?>">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('sumber_daya/pkm_delete/'.$r->id) ?>" class="btn btn-sm btn-link p-0 text-danger" onclick="return confirm('Hapus data ini?')"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
