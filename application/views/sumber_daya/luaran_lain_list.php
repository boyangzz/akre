                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('sumber_daya/luaran_lain_delete/'.$r->id) ?>" class="btn btn-sm btn-link p-0 text-danger" onclick="return confirm('Hapus data luaran ini?')"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
