<div class="page-header">
    <h4><i class="bi bi-flask me-2"></i><?= $page_title ?></h4>
...
<div class="row">
    <div class="col-md-4">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="<?= base_url('litabmas/save_penelitian') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Tema Penelitian (Roadmap)</label>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php if(empty($records)): ?>
                                <tr><td colspan="7" class="text-center py-4 text-muted italic">Belum ada data penelitian yang melibatkan mahasiswa.</td></tr>
                            <?php endif; ?>
